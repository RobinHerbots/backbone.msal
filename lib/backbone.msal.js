...
XMLHttpRequest.prototype.send = function () {
	var xhr = this, authContext = Backbone.sync.authContext,
		scopes = authContext ? authContext.getScopesForEndpoint(this._url) : null;
	if (scopes === null) return originXMLHttpRequest_send.apply(this, arguments);
	authContext.acquireTokenSilent({
		...
		return originXMLHttpRequest_send.apply(xhr, arguments);
	}, function (err) {
